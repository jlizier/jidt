...
1. [Download](../../wiki/Downloads) and [Installation](../../wiki/Installation) is very easy!
    ...
    1. _Python users_: `pip3 install "git+https://github.com/jlizier/jidt.git#subdirectory=python"` installs the toolkit, a Java runtime and all of the wiring in one step (see [python/README.md](python/README.md)).
