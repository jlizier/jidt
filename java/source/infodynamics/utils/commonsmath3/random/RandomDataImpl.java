...
import infodynamics.utils.commonsmath3.distribution.IntegerDistribution;
import infodynamics.utils.commonsmath3.distribution.RealDistribution;
...
public class RandomDataImpl implements RandomData, Serializable {
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.BetaDistribution Beta Distribution}.
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.BinomialDistribution Binomial Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.CauchyDistribution Cauchy Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.ChiSquaredDistribution ChiSquare Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.FDistribution F Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
     ...
     * {@link infodynamics.utils.commonsmath3.distribution.GammaDistribution Gamma Distribution}.</p>
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.HypergeometricDistribution Hypergeometric Distribution}.
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.PascalDistribution Pascal Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.TDistribution T Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.WeibullDistribution Weibull Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link infodynamics.utils.commonsmath3.distribution.ZipfDistribution Zipf Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
